...
├── analyzer.py                # Static analysis, relationship mapping, complexity metrics
├── app.py                     # Main Streamlit application and UI logic
├── diagram_generator.py       # Converts analysis to Graphviz DOT source
├── exporter.py                # Handles image (PNG/SVG) and documentation (MD/DOT) exports
├── llm_integration.py         # Handles calls to the Groq API for AI features
├── parser_module.py           # Multi-language code parsing (AST extraction)
├── requirements.txt           # Python dependencies
├── styles.css                 # Custom CSS for the Streamlit UI
├── theme_config.py            # Global theme variables
└── viewer.py                  # UI component for displaying diagram and editor


Generated by the Code-to-Diagram Generator Tool.
